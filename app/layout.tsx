...
function generateMetadata(): Metadata {
  ...
  return {
    ...
    description: "Welcome to the personal portfolio of Umer Aziz, a skilled web developer and software engineer based in Mirpur, Azad Kashmir, Pakistan. Explore my projects and services.",
