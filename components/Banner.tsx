    ...
    id='reviews' className='max-width padd-x padd-y'>
        <div className="flex flex-col items-center">
            <div className='mb-2 xl:mb-3 flex items-center gap-x-2'>
                ...
                <p className='max-w-xl text-lg text-center tracking-wider'>As I'm always looking for new opportunities, my inbox is always open. Schedule a call to discuss how I can help you meet your goals. Let's connect!</p>
